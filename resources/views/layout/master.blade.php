...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/owl.theme.default.css')}}">
    ...
    @if(!Request::is("contact_us") && !Request::is("/") && !Request::is("jobs") && !Request::is("login") && !Request::is("sign_up") && !Request::is("about_us"))
