            ...
            <div class="job_main_overflow jb_cover">
                <div class="latest_job_overlow jb_cover">
                    ...
                    <div class="latest_job_box jb_cover">
                        <div class="job_list recent_app_1">
                            <div class="recent_img">
                                <img src="{{asset('dashboard/images/rs4.jpg')}}" alt="post_img">
                            </div>
                            <div class="recent_cntnt">
                                <h6><a href="#">lumi simon</a></h6>
                                <ul>

                                    <li><i class="fas fa-suitcase"></i>&nbsp; UI/UX designer</li>
                                    <li><i class="flaticon-location-pointer"></i>&nbsp; Los Angeles</li>
                                </ul>
                    ...
                    <div class="latest_job_box jb_cover">
                        <div class="job_list recent_app_1">
                            <div class="recent_img">
                                <img src="dashboard/images/rs1.jpg" alt="post_img">
                            </div>
                            <div class="recent_cntnt">
                                <h6><a href="#">luca wallace</a></h6>
                                <ul>

                                    <li><i class="fas fa-suitcase"></i>&nbsp; graphic designer</li>
                                    <li><i class="flaticon-location-pointer"></i>&nbsp; Los Angeles</li>
                                </ul>
                    ...
                    <div class="latest_job_box jb_cover">
                        <div class="job_list recent_app_1">
                            <div class="recent_img">
                                <img src="dashboard/images/rs2.jpg" alt="post_img">
                            </div>
                            <div class="recent_cntnt">
                                <h6><a href="#">simmy jane</a></h6>
                                <ul>

                                    <li><i class="fas fa-suitcase"></i>&nbsp; software firmr</li>
                                    <li><i class="flaticon-location-pointer"></i>&nbsp; Los Angeles</li>
                                </ul>
                    ...
                    <div class="latest_job_box jb_cover">
                        <div class="job_list recent_app_1">
                            <div class="recent_img">
                                <img src="dashboard/images/rs3.jpg" alt="post_img">
                            </div>
                            <div class="recent_cntnt">
                                <h6><a href="#">luca wallace</a></h6>
                                <ul>
                    ...
                    <div class="latest_job_box jb_cover">
                        <div class="job_list recent_app_1">
                            <div class="recent_img">
                                <img src="dashboard/images/rs4.jpg" alt="post_img">
                            </div>
                            <div class="recent_cntnt">
                                <h6><a href="#">joah due</a></h6>
                                <ul>
